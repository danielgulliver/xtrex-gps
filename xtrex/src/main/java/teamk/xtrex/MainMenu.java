...
public class MainMenu extends Screen {
    ...
    private MainMenu(){
        ...
        WhereToButton = new MenuButton("Where To?", WhereTo.getInstance().getView(), "whereTo.png", "whereToSelected.png");
        TripComputerButton = new MenuButton("Trip Computer", TripComputer.getInstance().getView(), "odometer.png", "odometerSelected.png");
        MapButton = new MenuButton("Map", Maps.getMapViewInstance(), "map.png", "mapSelected.png");
        SpeechButton = new MenuButton("Speech", Speech.getSpeechViewInstance(), "speech.png", "speechSelected.png");
        SatelliteButton = new MenuButton("Satellite", SatelliteView.getInstance(), "satellite.png", "satelliteSelected.png");
        AboutButton = new MenuButton("About", AboutView.getInstance(), "about.png", "aboutSelected.png");
