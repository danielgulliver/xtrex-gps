...
public class MainMenu extends Screen {
    ...
    private MainMenu(){
        ...
        TripComputerButton = new MenuButton("Trip Computer", TripComputer.getInstance().getView());
        MapButton = new MenuButton("Map", Maps.getMapViewInstance());
        ...
        AboutButton = new MenuButton("About", AboutView.getInstance());
